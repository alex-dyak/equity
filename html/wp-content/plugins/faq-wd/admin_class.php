...
//                break;
    ...
    private function add_helper_bar($text, $user_guide_link) {
        ?>
        <div class="faqwd_help_bar_wrap">
            <span class="faqwd_help_bar_text"><?php _e($text, "faqwd"); ?></span>
            <a class="faqwd_hb_t_link" target="_blank" href=<?php echo $user_guide_link; ?>>
                <?php _e('Read More in User Guide', "faqwd"); ?>
            </a>
            <a class="faqwd_hb_buy_pro" target="_blank"
               href="https://web-dorado.com/products/wordpress-faq-wd.html"><?php _e('Upgrade to Pro Version', "faqwd"); ?>
            </a>
            <a class="faqwd_hb_s_link" target="_blank" href="https://wordpress.org/support/plugin/faq-wd">
                <img src="<?php echo FAQ_URL; ?>/images/i_support.png">
                <span class="faqwd_hb_s_text"><?php _e('Support Forum', "faqwd"); ?></span>
            </a>
        </div>
        <?php
    }
