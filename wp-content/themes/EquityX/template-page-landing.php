			...
			<article class="post" id="post-<?php the_ID(); ?>">
				<section class="row column">
					<div class="intro_section_widget introLanding">
						<div class="introLanding-inner introLanding-inner-flex u-clearfix">
							<div class="introLanding-inner-rightCol introLanding-flex-rightCol">
							...
							<div class="introLanding-inner-leftCol introLanding-flex-leftCol">
							...
							<?php // checked box - to display the block, check the box
							$checkedBox = get_field( 'checked_box', 'option' );
							if ( isset( $checkedBox ) && $checkedBox === true ) {
							?>
									...
									if ( have_rows( 'startup_and_expert_block', 'option' ) ): // loop through the rows of data
										while ( have_rows( 'startup_and_expert_block', 'option' ) ) : the_row();
											if ( get_row_layout() == 'block_title' ): ?>
												<div
													class="expert-title u-clear--both"><?php echo the_sub_field( 'title' ); ?></div>
											<?php elseif ( get_row_layout() == 'startup_block' ): ?>
												<div
													class="introLanding-statistic-statCol">
													<div class="startup-number">
														<!-- mfunc -->
														<?php echo the_sub_field( 'current_number' ); ?><!-- /mfunc --></div>
													<div
														class="startup-text"><?php echo the_sub_field( 'text' ); ?></div>
												</div>
											<?php elseif ( get_row_layout() == 'expert_block' ): ?>
												<div
													...
													<div class="expert-number">
														...
														<?php echo the_sub_field( 'current_number' ); ?><!-- /mfunc --></div>
													<div
														class="expert-text"><?php echo the_sub_field( 'text' ); ?></div>
												</div>
											<?php endif;
										endwhile;
									endif; ?>
