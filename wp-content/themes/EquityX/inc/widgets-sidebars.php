...
class Join_Us_Button_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="u-text--center joinUsWidget">
			<a href="<?php echo $link ?>" class="btn btn--hasIcon btn--linkedIn" target="_blank" data-linkedin-login>
				<span class="btn-icon">
...
class Join_Us_White_Button_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="u-text--center joinUsWidget joinUsWidget--small">
			<a href="<?php echo $link ?>" class="btn btn--white btn--hasIcon btn--linkedIn" target="_blank" data-linkedin-login>
				<span class="btn-icon">
					<svg class="svgIcon btn-icon-svgLinkedin">
						<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#linkedin"></use>
					</svg>
